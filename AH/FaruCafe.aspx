<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaruCafe.aspx.cs" Inherits="AH.FaruCafe" %>
...
<%@ Register Src="~/Control/contentFaruCafe.ascx" TagPrefix="uc1" TagName="contentFaruCafe" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8">
    <title>Faru Cafe & Protein | An Hoa</title>
...
<body>
    <form id="form1" runat="server">
         <div class="page-wrapper">
             ...
             <uc1:contentFaruCafe runat="server" ID="contentFaruCafe" SliderType="HOME" />
