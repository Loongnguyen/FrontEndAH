<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KhuyenMai.aspx.cs" Inherits="AH.KhuyenMai" %>
...
<%@ Register Src="~/Control/bannerPromotion.ascx" TagPrefix="uc1" TagName="bannerPromotion" %>
<%@ Register Src="~/Control/promotionPageArticles.ascx" TagPrefix="uc1" TagName="promotionPageArticles" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Khuyến mãi | An Hoa</title>
...
<body>
    <form id="form1" runat="server">
         <div class="page-wrapper">
             ...
             <uc1:bannerPromotion runat="server" ID="bannerPromotion" TopType="HOME" />
             <uc1:promotionPageArticles runat="server" ID="promotionPageArticles" ContentType="HOME" />
