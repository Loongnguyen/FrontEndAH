<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TuyenDung.aspx.cs" Inherits="AH.TuyenDung" %>
...
<%@ Register Src="~/Control/topRecruitment.ascx" TagPrefix="uc1" TagName="topRecruitment" %>
<%@ Register Src="~/Control/recruitmentPageArticles.ascx" TagPrefix="uc1" TagName="recruitmentPageArticles" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Tuyển dụng | An Hoa</title>
...
<body>
    <form id="form1" runat="server">
        <div class="page-wrapper">
            ...
            <uc1:topRecruitment runat="server" ID="topRecruitment" TopType="HOME" />
            <uc1:recruitmentPageArticles runat="server" ID="recruitmentPageArticles" ContentType="HOME" />
