<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SongKhoe.aspx.cs" Inherits="AH.SongKhoe" %>
...
<%@ Register Src="~/Control/contentLiveStrong.ascx" TagPrefix="uc1" TagName="contentLiveStrong" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Sống khỏe | An Hoa</title>
...
<body>
    <form id="form1" runat="server">
         <div class="page-wrapper">
             ...
             <uc1:contentLiveStrong runat="server" ID="contentLiveStrong" ContentType="HOME" />
